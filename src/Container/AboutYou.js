                    ...
                    <Col md={12} className="inner-padding">
                        <div className="display-inline">
                            <Col md={6} className="inline-content width50">
                                <InputWithLabel text="YOUR NAME" onChange={this.handleChange.bind(this, 'name')} />
                                {errorInd && <p className="hasError">
                                    {errors.name}
                                    </p>}
                            </Col>
                            <Col md={6} className="inline-content width50">
                                <InputWithOption text="YOUR ROLE" Option={['Head Chef', 'Chef', 'Junior Chef']} onChange={this.handleChange.bind(this, 'role')} />
                            </Col>
                        </div>
                        <div className="display-inline">
                            <Col md={6} className="inline-content width50">
                                <InputWithLabel text="RESTAURENT NAME" onChange={this.handleChange.bind(this, 'resName')} />
                                {errorInd && <p className="hasError">
                                    {errors.resName}
                                    </p>}
                            </Col>
                            <Col md={6} className="inline-content width50">
                                <InputWithOption text="RESTAURENT TYPE" Option={['Regional', 'Regional', 'Regional']} onChange={this.handleChange.bind(this, 'resType')} />
                            </Col>
                        </div>
                        <Col md={12} className="inline-content">
                            <InputWithLabel text="PHONE NUMBER" type="number" onChange={this.handleChange.bind(this, 'phone')} />
                            {errorInd && <p className="hasError">
                                    {errors.phone}
                                    </p>}
                        </Col>
                        <Col md={12} className="inline-content">
                            <InputWithLabel text="COMPANY ADDRESS" onChange={this.handleChange.bind(this, 'address')} />
                            {errorInd && <p className="hasError">
                                    {errors.address}
                                    </p>}
                        </Col>
